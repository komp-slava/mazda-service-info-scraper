...
username = 'email'
password = 'password'
base_url = 'https://am.mazdaserviceinfo.com/mazdagms3/index?page=...'
...
def login_to_service_portal(driver):
  ...
  try:
    driver.find_element(By.XPATH, "//button[@class='delete']").click()
  except:
    pass
  ...
  # Open ESI page
  driver.find_element(By.XPATH, "//span[contains(text(),'Electronic Service Information')]").click()
  driver.find_element(By.XPATH, "//button[contains(text(),'Open Electronic Service Information')]").click()
  time.sleep(5)
...
options = Options()
# Next line can be commited for debugging purposes
